...
class EnsembleModelAgent(Agent):
    ...
    SECTOR_WEIGHT_OVERRIDES: dict[str, dict[str, float]] = {
        ...
        # 2026-07-18 — elo_agent.py now carries K_FACTORS["nhl"]=6.0 and
        # HOME_ADVANTAGE_ELO["nhl"]=48.0 (swept via scripts/backtest_nhl_elo.py)
        # and elo_state.json['nhl'] is seeded. The 0 is therefore an UNMADE
        # BLEND DECISION: raising it needs a walk-forward, not a calibration.
