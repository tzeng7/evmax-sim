...
import { probToCents, probToAmerican, outcomeLabel } from '../lib/odds'
            ...
            {filtered.slice(0, 40).map(b => {
              ...
              return (
                <tr key={b.market_id}>
                  ...
                  <td className="num">{probToCents(b.blended_true_prob)} <span className="muted">({probToAmerican(b.blended_true_prob)})</span></td>
