...
export async function fetchArbSectors(): Promise<string[]> {
  return fetch('/api/arb/sectors').then(json).then((d: { sectors: string[] }) => d.sectors)
}
